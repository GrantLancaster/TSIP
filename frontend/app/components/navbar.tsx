      ...
      <div className="flex justify-center absolute top-0 w-full">
          <nav className="flex justify-between w-[85%] max-w-6xl h-14 bg-black/0 rounded-full">
            <ul className=" text-base flex justify-center items-center gap-8">
              ...
              <li className="px-2 hover:border-b-4 h-[28px] border-b-violet-500 text-center">Home</li>
              <li className="px-2 hover:border-b-4 h-[28px] border-b-violet-500 text-center">Feed</li>
              <li className="px-2 hover:border-b-4 h-[28px] border-b-violet-500 text-center">Profile</li>
            </ul>
